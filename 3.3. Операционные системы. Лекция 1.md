...
Нужно перенаправить стандартный поток ввода вывода, направить на его ввод пустую строку в нужный нам файл.<br>
Т.е. делаем "эхо" ничего в этот файл.<br>
...
Если да - мне нужно в этом manual найти информацию? <br>
`man 2 execve`
?
...
вопрос, можно ли через какой нибудь оператор сразу считать все процессы, что то вроде <br>
...
как вывести наиболее часто встречающийся статус? <br>
